...
class AdminBannerController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        if($request->hasFile('banner_job_listing')) {
            $request->validate([
                'banner_job_listing' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_job_detail')) {
            $request->validate([
                'banner_job_detail' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_job_categories')) {
            $request->validate([
                'banner_job_categories' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_company_listing')) {
            $request->validate([
                'banner_company_listing' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_company_detail')) {
            $request->validate([
                'banner_company_detail' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_pricing')) {
            $request->validate([
                'banner_pricing' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_blog')) {
            $request->validate([
                'banner_blog' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_post')) {
            $request->validate([
                'banner_post' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_faq')) {
            $request->validate([
                'banner_faq' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_contact')) {
            $request->validate([
                'banner_contact' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_terms')) {
            $request->validate([
                'banner_terms' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_privacy')) {
            $request->validate([
                'banner_privacy' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_login')) {
            $request->validate([
                'banner_login' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_signup')) {
            $request->validate([
                'banner_signup' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_forget_password')) {
            $request->validate([
                'banner_forget_password' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_company_panel')) {
            $request->validate([
                'banner_company_panel' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
        ...
        if($request->hasFile('banner_candidate_panel')) {
            $request->validate([
                'banner_candidate_panel' => 'image|mimes:jpg,png,jpeg,gif'
            ]);
