...
@section('heading', 'Page Pricing Content')
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin_pricing_page_update') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="meta_description" class="form-control h-100" cols="30" rows="10">{{ $page_pricing_data->meta_description }}</textarea>
                            </div>
