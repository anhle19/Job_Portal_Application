...
@section('heading', 'Page Others Content')
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link active" id="v-pills-1-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-1" aria-selected="true">Login Page</button>

                                        <button class="nav-link" id="v-pills-2-tab" data-bs-toggle="pill"
                                            data-bs-target="#v-pills-2" type="button" role="tab"
                                            aria-controls="v-pills-2" aria-selected="false">Signup Page</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea name="login_page_meta_description" class="form-control h_100" cols="30" 
                                        ...
                                        <div class="tab-pane fade" id="v-pills-2" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        <label class="form-label">Meta Description </label>
                                                        <textarea name="signup_page_meta_description" class="form-control h_100" cols="30" 
                                        ...
                                        <div class="tab-pane fade" id="v-pills-3" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        <label class="form-label">Meta Description </label>
                                                        <textarea name="forget_password_page_meta_description" class="form-control h_100" cols="30" 
