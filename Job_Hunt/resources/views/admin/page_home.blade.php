                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-7" role="tabpanel"
                                            aria-labelledby="v-pills-7-tab" tabindex="7">
                                            {{-- SEO Section Start --}}
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea name="meta_description" class="form-control h_100" 
                                                        cols="30" rows="10">{{ $page_home_data->meta_discription }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- SEO Section End --}}
