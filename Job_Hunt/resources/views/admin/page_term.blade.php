...
@section('heading', 'Page Terms Of Use Content')
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin_term_page_update') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="meta_description" class="form-control h-100" cols="30" rows="10">{{ $page_term_data->meta_description }}</textarea>
                            </div>
