<ul class="list-group list-group-flush">
    ...
    <li class="list-group-item {{ Request::is('company/jobs') || Request::is('company/job-edit/*')  ? 'active':'' }}">
    ...
    <li class="list-group-item {{ Request::is('company/candidate-applications') || Request::is('company/applicants/*') 
    || Request::is('company/applicants-detail/*')  ? 'active':''}}">
